...
<head>
    ...
    <title>Steps - Modern Corporate Html Template</title>
    <!-- ==================Start Css Link===================== -->
    <!--  fonts  -->
...
<body>
    ...
    <!-- 
========================================
OPPS AREA START FORM HERE
========================================
-->
    <div class="steps-opps-area">
        <div class="opps-table">
            <div class="opps-tabel-cell">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="steps-opps-content">
                                <h2>Page Not Found</h2>
                                <img src="assets/images/section-img/404-Page-.png" alt="">
                                <div class="middle-con">
                                    <p>Here's the story of a lovely lady who was bringing up three very lovely girls. Today still wanted by the government they survive as soldiers of fortune. black gold And if you threw a everyone you knew. </p>
                                </div>
                                <a href="#!" class="btn-mr white waves-effect waves-teal">Go To Home</a>
                            </div>
                        </div>
                    </div>
                </div>
