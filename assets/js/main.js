/*
* ----------------------------------------------------------------------------------------
    Template Name: Steps - Modern Corporate Html Template
    ...
    jQuery(document).on("ready", function () {
        ...
        */
        $(".slider-active-home-one").on("translate.owl.carousel", function () {
            ...
            $(".slide-content a.btn-mr").removeClass("animated slideInLeft").css("opacity", "0");
            $(".slide-content a.btn-mr.white").removeClass("animated slideInRight").css("opacity", "0");
        });
        ...
        $(".slider-active-home-one").on("translated.owl.carousel", function () {
            ...
            $(".slide-content a.btn-mr").addClass("animated slideInLeft").css("opacity", "1");
            $(".slide-content a.btn-mr.white").addClass("animated slideInRight").css("opacity", "1");
        });
