...
<div class="step-product-carosel">
                ...
                <div class="col-md-12">
                    <div class="product-carosel-active owl-carousel">
                        <div class="single-product">
                            <img src="assets/images/product/p1.png" class="responsive-img" alt="">
                        </div>
                        <!-- end single product -->
                        <div class="single-product">
                            <img src="assets/images/product/p2.png" class="responsive-img" alt="">
                        </div>
                        <!-- end single product -->
                        <div class="single-product">
                            <img src="assets/images/product/p3.png" class="responsive-img" alt="">
                        </div>
                        <!-- end single product -->
                        <div class="single-product">
                            <img src="assets/images/product/p4.png" class="responsive-img" alt="">
                        </div>
                        <!-- end single product -->
                        <div class="single-product">
                            <img src="assets/images/product/p5.png" class="responsive-img" alt="">
                        </div>
                        <!-- end single product -->
                        <div class="single-product">
                            <img src="assets/images/product/p6.png" class="responsive-img" alt="">
                        </div>
                        <!-- end single product -->
                        <div class="single-product">
                            <img src="assets/images/product/p1.png" class="responsive-img" alt="">
    ...
    <!-- 
========================================
STEP PRODUCT CAROSEL AREA END FORM HERE
========================================
-->
